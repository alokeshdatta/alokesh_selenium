...
public class test {
	...
	public void validLoginTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name=\"post_title\"]")).sendKeys(e);
		driver.findElement(By.xpath("//textarea[@id='content']")).sendKeys(e);

		driver.findElement(By.xpath("//input[@id='publish']")).click();
		driver.findElement(By.xpath("//a[contains(text(), 'View post')]")).click();
		
		WebElement ab = driver.findElement(By.xpath("//div[@class='property-title']/h2"));
		String a = ab.getText();
