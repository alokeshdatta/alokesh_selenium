...
public class CreatePropertyDetails_RETC_44 {
	...
	public void profileDetailsTest() throws InterruptedException {
		...
		Thread.sleep(2000);
		loginAdmin.clickFeatures();
		Thread.sleep(2000);
		loginAdmin.sendFeaturesName(e);
		loginAdmin.sendFeaturesSlug("Test_Launch");
		loginAdmin.sendFeaturesDescription("Test_New Launches of villas, apartments, flats");
		loginAdmin.clickAddNewFeatureButton();
		loginAdmin.clickAddNewLink();
		Thread.sleep(2000);
		loginAdmin.sendPropertiesTitle("test_Prestige");
		loginAdmin.sendPropertiesTitle("test_Kolkata");
